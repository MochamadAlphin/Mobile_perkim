...
import '../logic/logic_dashboard.dart'; // Import logika bisnis terpisah

class DashboardScreen extends StatefulWidget {
  // PERBAIKAN UTAMA: Wajib tangkap parameter token dari halaman login agar tidak null!
  final String token;
...
class _DashboardScreenState extends State<DashboardScreen> {
  // Inisialisasi Kelas Logic Utama dengan Callback onUpdate untuk Reaktivitas State
  late final DashboardLogic _logic;

  // Global Brand Color Palette (Sesuai Desain Awal)
  ...
  void initState() {
    ...
    // PERBAIKAN UTAMA 401: Ikat token dari widget ke dalam DashboardLogic saat init state
    _logic = DashboardLogic(
      authToken: widget.token,
      onUpdate: () {
        if (mounted) {
          setState(() {}); // Memaksa UI me-render ulang ketika data dari API selesai di-proses
        }
      },
    );
  ...
  // Pemanggilan fungsi sinkronisasi dari lib/logic
  Future<void> _loadDashboardData() async {
    if (!mounted) return;

    // PERBAIKAN UTAMA 401: Selalu teruskan token ter-update ke dalam fungsi fetch data
    await _logic.fetchDashboardData(updatedToken: widget.token);
  }

  @override
  Widget build(BuildContext context) {
    // Menghitung persentase rasio keterisian unit secara dinamis berdasarkan data API ter-update
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => _loadDashboardData(), // Refresh data dari server API Laravel
          ),
        ],
      ),
      body: _logic.isLoading
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // 1. Header Ucapan (Dinamis Sesuai Login Akun Admin yang Aktif)
              Text(
              ...
              // 2. CARD REMINDER / PERHATIAN SISTEM (INTEGRASI DATA API REALTIME)
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Notifikasi Jadwal Wawancara Masuk dari API
                    Text(
                    ...
                    // Notifikasi Kontrak Jatuh Tempo (Kalkulasi Otomatis H-7 dari API)
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'Kritis H-7: Ada ${_logic.kontrakAkanHabis} kontrak akomodasi yang habis dalam waktu kurang dari 1 minggu.',
              ...
              GridView.count(
                ...
                children: [
                  ...
                  _buildSummaryCard(
                    ...
                    value: '${_logic.kontrakAkanHabis} Kontrak',
              ...
              _logic.daftarWawancara.isEmpty
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                    ...
                    clipBehavior: Clip.antiAlias, // Mencegah clipping ripple effect
                    decoration: BoxDecoration(
                      color: Colors.white,
                      borderRadius: BorderRadius.circular(10),
                      border: Border.all(color: Colors.grey.shade200, width: 0.8),
                    ),
                    // PERBAIKAN UTAMA INKWELL WARNING: Menggunakan Material transparan di atas container
                    child: Material(
